...
class Escena
{
   ...
   const int NUM_MODOS      = 6,	// representa las opciones de dibujo
			 ...
			 NUM_COPO		= 11,	// numero asignado al copo
			 NUM_MATERIALES = 2,	// representa el numero de materiales
   ...
   // Material blanco
   Tupla4f colorAmbienteDifusoBlanco = {1.0, 1.0, 1.0, 1.0},
   		   colorEspecularBlanco = {1.0, 1.0, 1.0, 1.0};
	float brilloBlanco = 100.0;

	// Material azul turquesa
	Tupla4f colorAmbinteDifusoTurquesa = {0.2, 0.8, 0.8, 1.0},
			colorEspecularTurquesa = {1.0, 1.0, 1.0, 1.0};
	float brilloTurquesa = 3.0;
